                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        {{-- Payment button (only when not completed) --}}
                                        @if($sale->status->value !== 'completed')
                                            <a href="{{ route('selling.show', $sale->id) }}" class="inline-flex items-center justify-center bg-teal-100 hover:bg-teal-200 text-teal-700 w-10 h-10 rounded-full transition-colors duration-200" title="Bayar">
                                        ...
                                        {{-- Detail view button (always available) --}}
                                        <a href="{{ route('selling.detail', $sale->id) }}" class="inline-flex items-center justify-center bg-white border hover:bg-gray-50 text-gray-700 w-10 h-10 rounded-full transition-colors duration-200" title="Detail">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#111827" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.35-4.35"></path></svg>
                                        </a>
                                    </div>
                                </td>
                            </tr>
